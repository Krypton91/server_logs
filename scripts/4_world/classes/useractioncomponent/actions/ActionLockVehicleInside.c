modded class ActionLockVehicleInside
{
    ...
    override void OnFinishProgressServer(ActionData action_data)
    {
        ...
        if(GetGame().IsServer())
        {
            ...
            DBMLogger.LogJson(playerID.GetName(), playerID.GetPlainId(), player.GetPosition(), "locked " + vehicle.GetDisplayName(), vehicle.GetPosition());
        }
    }
}